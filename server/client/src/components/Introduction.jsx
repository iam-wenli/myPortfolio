...
function Introduction() {
  ...
  return (
    <div className="font-serif p-12 bg-orange-200 h-screen">
      <h1 className='text-left font-bold text-2xl py-3 pb-10 sm:text-4xl'>Introduction</h1>
      <p className='font-normal text-justify text-base sm:text-xl leading-7 first-letter:text-7xl first-letter:font-bold first-letter:text-rose-900  first-letter:float-left first-letter:mr-3'>
