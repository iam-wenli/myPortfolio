...
function Skills() {
  ...
  return (
    <>
    <div
      className="font-serif p-12 h-screen relative transition-colors duration-500"
      style={{
        backgroundColor: checked ? '#a5b4fc' : '#000000',
      }}
    >
      <h1 className="text-left font-bold text-3xl sm:text-5xl py-3 pb-10">Tech Stacks</h1>
      ...
      <section className='basis-1/4'>
        <h3 className='text-left text-xl sm:text-3xl pb-3 font-bold'>Backend</h3>
        <ul className='list-none text-base sm:text-xl leading-relaxed'>
          <li>MySQL</li>
          <li>NoSQL</li>
          <li>MongoDB</li>
      ...
      <section className='basis-1/4'>
        <h3 className='text-left text-xl sm:text-3xl pb-3 font-bold'>Others</h3>
        <ul className='list-none text-base sm:text-xl leading-relaxed'>
          <li>Vite</li>
          <li>VS Code</li>
          <li>Git/ Github</li>
      ...
      <div className='absolute bottom-28 left-12 flex flex-col'>
        ...
        <cite className='text-indigo-50 text-base mt-3'>&#91; Click here for lighting &#93;</cite>
      </div>
    </div>
    </>
  ) 
