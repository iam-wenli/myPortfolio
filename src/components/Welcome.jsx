...
function Welcome() {
  ...
  const welcomeAnimationProps = {
    mobile:{from:{opacity:0, backgroundcolor:'#06b6d4', transform:'scale(0)'},
           to:{opacity:0.5, backgroundcolor:'#164e63', transform:'scale(3)'},
          config:{duration:1000}
  },
    tablet:{from:{opacity:0, backgroundcolor:'#06b6d4', transform:'scale(0)'},
          to:{opacity:0.5, backgroundcolor:'#164e63', transform:'scale(5)'},
          config:{duration:1000}
        },
    desktop:{from:{opacity:0, backgroundcolor:'#06b6d4', transform:'scale(0)'},
  ...
  return(
      <div className="bg-cyan-500 h-screen flex flex-col justify-center items-center">
          <animated.h1 style={welcomeEffect} className='font-serif mb-24 sm:mb-56'>
          Welcome
          </animated.h1>
        <svg width="5000" height="180" viewBox="80 -70 180 230">
          <path ref={beePathRef} d={beePath} fill="none" stroke="none" strokeWidth="0"/>
